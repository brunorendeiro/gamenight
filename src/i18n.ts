...
export const ui: Record<Locale, UiStrings> = {
  ...
  fr: {
    ...
    cookieBody: "J'utilise Google Analytics et Google AdSense pour comprendre combien de personnes visitent ce projet. Acceptes-tu les cookies analytiques et publicitaires ?",
